    ...
    public static func showEmptyDataView<T: UIView>(for view: UIView,
        ...
        if let _ = view as? UITableView {
            ...
            if !hasSwizzledUITableViewReloadData {
                ...
                self.swizzlingMethod(UITableView.self,
            ...
            if !hasSwizzledUICollectionViewReloadData {
                ...
                self.swizzlingMethod(UICollectionView.self,
                                     originalSelector: reloadOriginalSelector,
                                     swizzledSelector: reloadSwizzledSelector)
            }
        }
...
extension EmptyDataSet {
    ...
    fileprivate static func swizzlingMethod(_ cls: AnyClass, originalSelector: Selector, swizzledSelector: Selector) {
    ...
    static var emptyDataSetResourceBundle: Bundle? {
        if let path = Bundle(for: EmptyDataSet.self).path(forResource: "EmptyDataSet-Swift", ofType: "bundle") {
